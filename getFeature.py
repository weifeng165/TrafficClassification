...
def feature(pcapPath, appDir):
    ...
    singleFeature = (maxInterval, minInterval, avgInterval, stdInterval, maxSize, minSize, avgSize, stdSize, maxupInterval, minupInterval, avgupInterval, stdupInterval,
...
for appDir in os.listdir(inputDir):
    ...
    for pcapFile in os.listdir(appPath):
        ...
        if (appDir not in nonVideo and i < pcapcount*0.7) or (appDir in nonVideo and i < nonVideopcapcount*0.7):
